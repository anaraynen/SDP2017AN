...
class PublicVirtualMachineParserSuite extends FunSuite with ByteCodeValues {
  ...
  test("[8] vm parser should parse programs/p01.vm a file into bytecode") {
    //val code = vmp.parse("/Users/anaraynen/Programming/Scala/SDP/coursework/cw-two/programs/p01.vm")
    val code = vmp.parse("C:\\Users\\Ameer\\Documents\\SDP\\coursework\\cw-two\\programs\\p01.vm")
  ...
  test("[8] vm parser should parse programs/p03.vm a file into bytecode") {
    //val code = vmp.parse("/Users/anaraynen/Programming/Scala/SDP/coursework/cw-two/programs/p03.vm")
    val code = vmp.parse("C:\\Users\\Ameer\\Documents\\SDP\\coursework\\cw-two\\programs\\p03.vm")
  ...
  test("[4] vm parser should detect a program with invalid bytecode") {
    intercept[InvalidBytecodeException] {
      //val code = vmp.parse("/Users/anaraynen/Programming/Scala/SDP/coursework/cw-two/programs/p04-bad-program.vm")
      val code = vmp.parse("C:\\Users\\Ameer\\Documents\\SDP\\coursework\\cw-two\\programs\\p04-bad-program.vm")
    }
  }
}
