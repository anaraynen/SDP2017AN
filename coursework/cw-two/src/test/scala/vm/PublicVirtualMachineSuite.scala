...
class PublicVirtualMachineSuite extends FunSuite {
  ...
  test("[10] a virtual machine should execute a program") {
    //val bc  = vmp.parse("/Users/anaraynen/Programming/Scala/SDP/coursework/cw-two/programs/p05.vm")
    val bc  = vmp.parse("C:\\Users\\Ameer\\Documents\\SDP\\coursework\\cw-two\\programs\\p05.vm")
