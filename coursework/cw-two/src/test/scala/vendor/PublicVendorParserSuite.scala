...
class PublicVendorParserSuite extends FunSuite {
  ...
  test("[4] vendor parser should parse a program file correctly") {
    //val insts = vp.parse("/Users/anaraynen/Programming/Scala/SDP/coursework/cw-two/programs/p03.vm")
    val insts = vp.parse("C:\\Users\\Ameer\\Documents\\SDP\\coursework\\cw-two\\programs\\p03.vm")
