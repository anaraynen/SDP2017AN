...
class PublicScalaBasicsSuite extends FunSuite {
  ...
  test("[5] The minWhile function should return the minimum integer in an array using a while loop") {
    ...
    TreeTraversals.getMethod("/Users/anaraynen/Programming/Scala/SDP/Exercises/week03/scalabasics/src/main/scala/basics/ScalaBasics.scala", "minWhile") match {
      case Some(method) =>
  ...
  test("[5] The minFor function should return the minimum integer in an array using a for loop") {
    TreeTraversals.getMethod("/Users/anaraynen/Programming/Scala/SDP/Exercises/week03/scalabasics/src/main/scala/basics/ScalaBasics.scala", "minFor") match {
      case Some(method) =>
  ...
  test("[5] The minRecursive function should return the minimum integer in an array using recursion") {
    TreeTraversals.getMethod("/Users/anaraynen/Programming/Scala/SDP/Exercises/week03/scalabasics/src/main/scala/basics/ScalaBasics.scala", "minRecursive") match {
      case Some(method) =>
  ...
  test("[6] isPalindrome should return true if a string is a palindrome") {
    TreeTraversals.getMethod("/Users/anaraynen/Programming/Scala/SDP/Exercises/week03/scalabasics/src/main/scala/basics/ScalaBasics.scala", "isPalindrome") match {
      case Some(method) =>
        assert(!TreeTraversals.hasVarDef(method), "Your implementation used a var declaration")
